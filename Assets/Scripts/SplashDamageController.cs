...
public class SplashDamageController : MonoBehaviour
{
    ...
    private const string DefaultSplashEffectResourcePath = "SplashDamage";
    ...
    [Tooltip("스플래시 데미지가 발동할 때 명중 위치에 생성할 이펙트 프리팹입니다. 비워두면 Resources/SplashDamage 프리팹을 자동으로 사용합니다.")]
    [FormerlySerializedAs("splashEffectPrefab")]
    [SerializeField] private GameObject splashDamageEffectPrefab;
    ...
    {
        get => splashDamageEffectPrefab;
        set => splashDamageEffectPrefab = value;
    }
    ...
    private void Awake()
    {
        ...
        ConfigureDefaultSplashEffectPrefab();
    }
    ...
    {
        GameObject prefab = ResolveSplashEffectPrefab();
        if (prefab == null)
        {
            return;
        }
    ...
    private GameObject ResolveSplashEffectPrefab()
    {
        ConfigureDefaultSplashEffectPrefab();
        return splashDamageEffectPrefab;
    }

    private void ConfigureDefaultSplashEffectPrefab()
    {
        if (splashDamageEffectPrefab != null)
        {
            return;
        }

        splashDamageEffectPrefab = Resources.Load<GameObject>(DefaultSplashEffectResourcePath);
    }
